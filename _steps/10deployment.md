...
![Gemfile](http://localhost:4000/assets/Gemfile.jpg)
...
![Command serve](http://localhost:4000/assets/openservecommand.jpg)
...
![Gemfile with plugin](http://localhost:4000/assets/Gemfilewithplugin.jpg)

Then add these lines to your `_config.yml`:

![Configyml with plugin](http://localhost:4000/assets/configymlwithplugin.jpg)
...
![dafault with plugin](http://localhost:4000/assets/defaulthtmlwithplugin.jpg)
...
![Jekyll Environment Build](http://localhost:4000/assets/jekyllenvibuild.jpg)
...
![Jekyll Environment Code](http://localhost:4000/assets/jekyllenvi.jpg)
